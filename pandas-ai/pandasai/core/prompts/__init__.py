...
from .generate_analyze_report import GenerateAnalyzeReportPrompt
...
def get_analyze_report_prompt(context: AgentState) -> BasePrompt:
    return GenerateAnalyzeReportPrompt(
        context=context,
        last_code_generated=context.get("last_code_generated"),
        output_type=context.output_type,
    )
