...
class TypeBuilder(_TypeBuilder):
    def __init__(self):
        super().__init__(classes=set(
          ["Agents","Bus","Cell","ChatAgent","DynamicOutput","EventAll","EventAndLocationTyRel","EventFailAndLocationRel","EventKS","EventSB","EventTY","IndexAndBusRel","IndexAndCellRel","IndexAndNetUnitRel","IndexAndTermRel","IndexCE","IndexGL","IndexGL4g","IndexGlAndNetRel","IndexGlAndNetRel4g","IndexNU","IndexNetUnit","IndexOfBus","IndexOfCell","IndexOfTerm","IndexOverview","IndexOverview4g","IndexOverviewTriple4g","IndexYW","IndexZD","Location","LocationFail","LocationTy","NetEvent","NetEventAndLocationRel","NetEventFail","NetEventTy","NetOverview","NetOverview4g","NetUnit","PythonCode","Terminal",]
        ), enums=set(
          []
