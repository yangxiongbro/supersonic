...
//        return parseContext.getResponse();
        ...
        ChatParseResp result = parseContext.getResponse();
        SemanticParseInfo semanticParseInfo = new SemanticParseInfo();
        semanticParseInfo.setProperties(Collections.singletonMap("type", "internal"));
        result.setSelectedParses(Collections.singletonList(semanticParseInfo));
        return result;
    }
