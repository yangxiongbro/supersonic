...
public class MetricController {
    ...
    public MetricController(MetricService metricService, PandasAiSchemaService pandasAiSchemaService) {
    ...
    public MetricResp createMetric(@RequestBody MetricReq metricReq, HttpServletRequest request,
        ...
        MetricResp result = metricService.createMetric(metricReq, user);
        pandasAiSchemaService.updateSchema(Collections.singletonList(metricReq.getModelId()));
        return result;
    }
    ...
    public MetricResp updateMetric(@RequestBody MetricReq metricReq, HttpServletRequest request,
            HttpServletResponse response) throws Exception {
        User user = UserHolder.findUser(request, response);
        MetricResp result = metricService.updateMetric(metricReq, user);
        pandasAiSchemaService.updateSchema(Collections.singletonList(metricReq.getModelId()));
        return result;
    }
    ...
    public Boolean deleteMetric(@PathVariable("id") Long id, HttpServletRequest request,
        ...
        pandasAiSchemaService
                .updateSchema(Collections.singletonList(metricService.getMetric(id).getModelId()));
        return true;
    }
