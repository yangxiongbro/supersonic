...
public class ModelRelaServiceImpl extends ServiceImpl<ModelRelaDOMapper, ModelRelaDO>
    ...
    @Override
    public ModelRela getModelRelaById(Long relaId) {
        return convert(getById(relaId));
    }
    ...
    public List<ModelRelaDO> listDo(Wrapper<ModelRelaDO> wrapper) {
        return list(wrapper);
    }

    public Boolean batchSave(List<ModelRelaDO> list) {
