...
public class DimensionController {
    ...
    public DimensionResp createDimension(@RequestBody DimensionReq dimensionReq,
        ...
        DimensionResp result = dimensionService.createDimension(dimensionReq, user);
        pandasAiSchemaService.updateSchema(Collections.singletonList(dimensionReq.getModelId()));
        return result;
    }
    ...
    public Boolean deleteDimension(@PathVariable("id") Long id, HttpServletRequest request,
        ...
        pandasAiSchemaService.updateSchema(
                Collections.singletonList(dimensionService.getDimension(id).getModelId()));
        return true;
    }
